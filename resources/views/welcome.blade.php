                                ...
                                <div class="col-md-10 col-md-offset-1">
                                    <div class="section-header">
                                        ...
                                        <ul id="filter-list" class="clearfix">
                                            ...
                                            <li class="filter" data-filter=".{{$category->slug}}">{{ucfirst($category->name)}}<span class="badge">{{$category->items->count()}}</span></li>
                                            @endforeach
                                            @endif
                                        </ul><!-- @end #filter-list -->
                                    </div>
                                ...
                                <form class="reservation-form" method="post" action="{{route('reservation.reserve')}}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 col-sm-6">
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control reserve-form empty iconified" name="date_and_time" id="datepicker1" placeholder="&#xf017;  Time">
                                            </div>
                                        </div>
